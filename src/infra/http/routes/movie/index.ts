...
import { FindHighLights } from '@infra/http/controllers/movie/findHighLights/findHighLights.controller';
...
const findHighLightsController = new FindHighLights();
...
movieRoutes.get('/movies/highlights', findHighLightsController.handle);
